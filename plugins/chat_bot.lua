...
if msg.text == "آجی های عرفان" then
	return "اوووف جنده پولی هااا"
end
if msg.text == "اجی های عرفان" then
	return "😱با جنده ها کار داری؟"
end
if msg.text == "آجی عرفان" then
	return "اصن کوصن جنده پولییییی"
end
if msg.text == "اجی عرفان" then
	return "😏هع جنده ها از نوع پولی"
end
end
